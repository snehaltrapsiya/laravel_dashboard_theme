                ...
                <div class="page-title-heading">
                    <div>
                        <div class="page-title-head center-elem">
                            ...
                            <span class="d-inline-block">Update Role</span>
                        </div>
            ...
            <div class="card-body">
                <form action="{{ route('roles.update',$role->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="name" id="name" placeholder="Name" type="text" value="{{ (old('name')) ? old('name') : $role->name }}"  class="form-control" autofocus>
                            @error('name')
                    ...
                    <div class="position-relative row form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control"  placeholder="Description" id="description" name="description">{{ (old('description')) ? old('description') : $role->description }}</textarea>
                            @error('description')
